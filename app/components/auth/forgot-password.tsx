        ...
        <div className="form-container flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-indigo-800">
                      We'll send you a secure OTP code to reset your password.
              ...
              <form
                onSubmit={handleForgotPasswordSubmission}
            ...
            <div className="text-center">
              <p className="text-sm text-indigo-100">
                ...
                <a
                  href="#"
                  className="font-medium text-white hover:text-indigo-200 underline transition-colors duration-200"
                >
                  {" "}
                  Contact Support{" "}
                </a>
