...
//   updateGuestQuantity,
//   deleteGuestItem,
// } from "@/lib/store/guest/cart-slice";
...
//   const userCart = useAppSelector((state) => state.cartSlice.items);
//   const guestCart = useAppSelector((state) => state.guestSlice.items);
//   const status = isLoggedIn
//     ? useAppSelector((state) => state.cartSlice.status)
//     : Status.SUCCESS; // assume guest cart is always ready
...
//                 : undefined,
//             productStock: item.product.productStock ?? 0,
//           },
//           isGuest: false,
//         }))
//     : guestCart.map((item) => ({
//         id: item.productId,
//         quantity: item.quantity,
//         product: undefined, // guest items may not have full product info
//         isGuest: true,
//       }));
...
//   // --- Helpers ---
//   const getItemId = (item: CartItem) => item.id;
//   const getItemPrice = (item: CartItem) => item.product?.productPrice ?? 0;
...
//     if (!item.isGuest) {
//       dispatch(updateItemQuantity({ cartItemId: id, quantity: qty }));
//     } else {
//       dispatch(updateGuestQuantity({ productId: id, quantity: qty }));
//     }
//   };
...
//                     <img
//                       src={
//                         item.product?.productImage || "/images/placeholder.png"
//                       }
